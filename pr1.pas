...
begin
  if PLC.WriteRegister(StrToInt(Edit2.Text), StrToInt(Edit3.Text)) then
    MessageDlg('Успешная запись в регистр!', mtCustom, [mbOk], 0)
  else
    MessageDlg('Ошибка при записи в регистр', mtError, [mbOk], 0);
end;
